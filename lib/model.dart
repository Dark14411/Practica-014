...
abstract class GameUser implements Built<GameUser, GameUserBuilder> {
  static Serializer<GameUser> get serializer => _$gameUserSerializer;

  /// Nombre del usuario
  String get username;

  /// Mejor score (menor tiempo es mejor en segundos)
  int get bestScore;

  /// Total de crucigramas completados
  int get gamesCompleted;

  /// Timestamp del último juego
  @BuiltValueField(wireName: 'last_played')
  DateTime? get lastPlayed;

  factory GameUser([void Function(GameUserBuilder)? updates]) = _$GameUser;
  GameUser._();

  factory GameUser.create(String username) => GameUser(
    (b) => b
      ..username = username
      ..bestScore = 0
      ..gamesCompleted = 0
...
/// Representa el estado de una sesión de juego
abstract class GameSession implements Built<GameSession, GameSessionBuilder> {
  ...
  /// Tiempo de inicio del juego actual
  ...
  GameSession finishGame() {
    final updatedUser = user.rebuild((b) {
      b
